...
function App(props) {
  ...
  // const DepositBlock = tx(writeContracts.Staker.getBlock());
  // console.log(writeContracts.Staker.currentBlock());
  // console.log(writeContracts.Staker.currentBlock());
          ...
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              ...
              <Button
                ...
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(`${ether}`) }));
                }}
              >
                🥩 Stake {ether} ether!
              </Button>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={balanceStaked ? "success" : "primary"}
                onClick={() => {
                  tx(writeContracts.Staker.resetDeadlines());
                }}
              >
                Unlock Funds and reset Deadlines
              </Button>
            </div>
